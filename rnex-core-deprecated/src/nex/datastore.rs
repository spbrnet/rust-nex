...
use rnex_core::rmc::protocols::datastore::{
    ...
    DataStoreGetCourseRecordResult, DataStoreGetCustomRankingByDataIDParam,
    DataStorePrepareGetParam, DataStoreReportCourseParam, DataStoreReqGetInfo,
    DataStoreSearchParam, DataStoreUploadCourseRecordParam, GetMetaInfo, GetMetaParam, KeyValue,
    Permission, PersistenceTarget, RateCustomRankingParam, RatingInfo, RatingInfoWithSlot,
    RatingInitParamWithSlot,
};
